...
SIMP = { 
  ...
  def self.simplified_to_traditional string
	  string.collect |x| do
	    match = TRAD[x]
	    if match
	      if match.length == 1
  ...
  #alias simplified_to_traditional, s_to_t
  #alias traditional_to_simplified,t_to_s
  def self.traditional_to_simplified string
    string.collect{|x| SIMP[x] || x}.join
  end
end
class String
  def chinese?
